...
import 'package:hapticfone/features/store/controllers/dropdown_controller.dart';
import 'package:hapticfone/features/store/controllers/radio_controller.dart';
import 'package:hapticfone/data/repository/address_repository.dart';
...
class Addresscontroller extends GetxController {
  ...
  RxList<Addressmodels> addressforselected = <Addressmodels>[].obs;
  ...
  List get filtredselecteditems {
    if (addresslist.isEmpty) {
      return [];
    } else {
      var reault = addresslist.where((item) => item.selectedaddress == true);
      {
        addressforselected.assignAll(reault);
        return addressforselected;
      }
    }
  }
}
