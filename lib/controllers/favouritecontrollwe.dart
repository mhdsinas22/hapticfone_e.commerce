...
import 'package:hapticfone/repository/user/product_repository.dart';
...
class Favouritecontrollwe extends GetxController {
  ...
  //   if (json != null) {
  //     final stroedfavtoire = jsonDecode(json) as Map<String, dynamic>;
  //     favorite.assignAll(
  //       stroedfavtoire.map((key, value) => MapEntry(key, value as bool)),
  //     );
  //   }
  // }
  Future<void> initFavourite() async {
