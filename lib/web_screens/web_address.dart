...
import 'package:hapticfone/responsive_screen/responsice_addaddress_form_screen.dart';
...
import 'package:hapticfone/features/store/screens/adderss_section/selected_addressui.dart';

class WebadderssScreen extends StatelessWidget {
  const WebadderssScreen({super.key});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              TextbuttonCustomized(
                ...
                onpressed: () => Get.to(() => ResponsiceAddaddressFormScreen()),
          ...
          Padding(
            ...
            child: Row(
              children: [
                SizedBox(width: 3.w),
                Boldtext(size: 8, text: "MANGE ADDRESS"),
              ],
            ),
          ),
          Obx(() {
                  ...
                  return Dismissible(
                    onDismissed: (direction) {
                      if (direction == DismissDirection.endToStart) {
                        ...
                        Snackbars.waringsnakbar("Deleted", "Address Removed");
                      } else {
                        Get.to(
